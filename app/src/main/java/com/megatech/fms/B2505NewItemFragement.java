...
public class B2505NewItemFragement extends DialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (activity instanceof B2505Activity){
            ...
            userList = b2505Activity.userList;
            flights = b2505Activity.flightList;
            containers = b2505Activity.containerList;
            ...
            userList = refuelPreview.userListbm2505;
            flights = refuelPreview.flightList;
            containers = refuelPreview.containerList;
        }
